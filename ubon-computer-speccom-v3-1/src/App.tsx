  ...
  return (
    <div className="p-4 md:p-8 max-w-7xl mx-auto">
      ...
      <Dialog open={!!editing} onOpenChange={(o)=>!o && setEditing(null)}>
        <DialogContent className="sm:max-w-[720px] relative">
          <button aria-label="Close" onClick={()=>setEditing(null)} className="absolute right-3 top-3 rounded-full h-8 w-8 flex items-center justify-center hover:bg-muted"><X className="w-4 h-4"/></button>

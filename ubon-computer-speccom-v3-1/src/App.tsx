      ...
      <Card className="shadow-sm">
        ...
        <CardContent>
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between mt-3 text-sm text-muted-foreground"><span>ประมาณการกำลังไฟ ~ {estimateWattage(selection)}W</span><Button size="sm" variant="secondary" onClick={()=>setShowAllComp(s=>!s)}>{showAllComp ? "ย่อ" : "ดูทั้งหมด"}</Button></div>
          </div>
        </CardContent>
      </Card>
    </div>

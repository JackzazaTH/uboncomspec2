    ...
    <div className="p-4 md:p-8 max-w-7xl mx-auto">
      ...
      <Tabs defaultValue="builder" className="space-y-4">
        ...
        <TabsContent value="inventory" className="space-y-4">
          ...
          {editing && (
            <Card className="shadow-sm">
              <CardHeader><CardTitle>{editing?.id ? "แก้ไขสินค้า" : "เพิ่มสินค้า"}</CardTitle></CardHeader>
              <CardContent>
                <ProductEditor initial={editing||undefined} onSave={(p)=>{ saveProduct(p); setEditing(null); }} />
              </CardContent>
            </Card>
          )}
        </TabsContent>
